...
1. If you are combining a tags search with a TODO search, you can use
   the following:

   : computer|email/!NOW

1. Use [[https://orgmode.org/manual/Agenda-commands.html#Agenda-commands][agenda filtering]].
...
1. Finally, if you place a colon at the beginning of a query, the
